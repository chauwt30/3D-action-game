...
public class Skull : Enemy
{
    ...
    public override void InitData()
    {
        ...
        CurrState = new SkullState.IdelState();  
    }
    ...
    public override void OnHit(Skill skill)
    {
        if (Invisible == false)
        {
            ...
            {
                CurrState.CurrState.ChangeState(new SkullState.TakingDamage(), this);
            }
        }
    ...
    public override void Die()
    {
        ...
        CurrState.CurrState.ChangeState(new SkullState.Dying(), this);
    }
